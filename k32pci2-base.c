...
#define debug(_fmt, _args...) printk(KERN_DEBUG "[polygator-%s] %s:%d - %s(): " _fmt, THIS_MODULE->name, "k32pci2-base.c", __LINE__, __PRETTY_FUNCTION__, ## _args)

static int k32pci2_tty_at_open(struct tty_struct *tty, struct file *filp);
static void k32pci2_tty_at_close(struct tty_struct *tty, struct file *filp);
static int k32pci2_tty_at_write(struct tty_struct *tty, const unsigned char *buf, int count);
static int k32pci2_tty_at_write_room(struct tty_struct *tty);
static int k32pci2_tty_at_chars_in_buffer(struct tty_struct *tty);
#if LINUX_VERSION_CODE >= KERNEL_VERSION(2,6,20)
static void k32pci2_tty_at_set_termios(struct tty_struct *tty, struct ktermios *old_termios);
#else
static void k32pci2_tty_at_set_termios(struct tty_struct *tty, struct termios *old_termios);
#endif
static void k32pci2_tty_at_flush_buffer(struct tty_struct *tty);
static void k32pci2_tty_at_hangup(struct tty_struct *tty);

static struct tty_operations k32pci2_tty_at_ops = {
	.open = k32pci2_tty_at_open,
	.close = k32pci2_tty_at_close,
	.write = k32pci2_tty_at_write,
	.write_room = k32pci2_tty_at_write_room,
	.chars_in_buffer = k32pci2_tty_at_chars_in_buffer,
	.set_termios = k32pci2_tty_at_set_termios,
	.flush_buffer = k32pci2_tty_at_flush_buffer,
	.hangup = k32pci2_tty_at_hangup,
};
#ifdef TTY_PORT
static int k32pci2_tty_at_port_carrier_raised(struct tty_port *port);
static void k32pci2_tty_at_port_dtr_rts(struct tty_port *port, int onoff);
static int k32pci2_tty_at_port_activate(struct tty_port *tport, struct tty_struct *tty);
static void k32pci2_tty_at_port_shutdown(struct tty_port *port);

static const struct tty_port_operations k32pci2_tty_at_port_ops = {
	.carrier_raised = k32pci2_tty_at_port_carrier_raised,
	.dtr_rts = k32pci2_tty_at_port_dtr_rts,
	.activate = k32pci2_tty_at_port_activate,
	.shutdown = k32pci2_tty_at_port_shutdown,
};
#endif
...
static void k32pci2_vin_reset_0(uintptr_t cbdata)
{
	void __iomem *addr = (void __iomem *)cbdata;
	iowrite8(0, addr + 0x000 + 0x11c0);
	mdelay(10);
	iowrite8(1, addr + 0x000 + 0x11c0);
}

static void k32pci2_vin_reset_1(uintptr_t cbdata)
{
	void __iomem *addr = (void __iomem *)cbdata;
	iowrite8(0, addr + 0x200 + 0x11c0);
	mdelay(10);
	iowrite8(1, addr + 0x200 + 0x11c0);
}

static void k32pci2_vin_write_nwd_0(uintptr_t cbdata, u_int16_t value)
{
	void __iomem *addr = (void __iomem *)cbdata;
	iowrite16(value, addr + 0x1100 + 0x000  + 0x04);
}

static void k32pci2_vin_write_nwd_1(uintptr_t cbdata, u_int16_t value)
{
	void __iomem *addr = (void __iomem *)cbdata;
	iowrite16(value, addr + 0x1100 + 0x200 + 0x04);
}

static void k32pci2_vin_write_eom_0(uintptr_t cbdata, u_int16_t value)
{
	void __iomem *addr = (void __iomem *)cbdata;
	iowrite16(value, addr + 0x1100 + 0x000 + 0x08);
}

static void k32pci2_vin_write_eom_1(uintptr_t cbdata, u_int16_t value)
{
	void __iomem *addr = (void __iomem *)cbdata;
	iowrite16(value, addr + 0x1100 + 0x200 + 0x08);
}

static u_int16_t k32pci2_vin_read_nwd_0(uintptr_t cbdata)
{
	u_int16_t value;
	void __iomem *addr = (void __iomem *)cbdata;
...
static u_int16_t k32pci2_vin_read_nwd_1(uintptr_t cbdata)
{
	u_int16_t value;
	void __iomem *addr = (void __iomem *)cbdata;
...
static u_int16_t k32pci2_vin_read_eom_0(uintptr_t cbdata)
{
	u_int16_t value;
	void __iomem *addr = (void __iomem *)cbdata;
...
static u_int16_t k32pci2_vin_read_eom_1(uintptr_t cbdata)
{
	u_int16_t value;
	void __iomem *addr = (void __iomem *)cbdata;
...
static size_t k32pci2_vin_is_not_ready_0(uintptr_t cbdata)
{
	...
	st = ioread16(addr + 0x000 + 0x1120) & 1;
...
static size_t k32pci2_vin_is_not_ready_1(uintptr_t cbdata)
{
	...
	st = ioread16(addr + 0x200 + 0x1120) & 1;
...
#endif
static u_int16_t k32pci2_vin_read_dia_0(uintptr_t cbdata)
{
	u_int16_t value;
	void __iomem *addr = (void __iomem *)cbdata;
...
static u_int16_t k32pci2_vin_read_dia_1(uintptr_t cbdata)
{
	u_int16_t value;
	void __iomem *addr = (void __iomem *)cbdata;
...
static void k32pci2_gsm_mod_set_control(uintptr_t cbdata, size_t pos, u_int8_t reg)
{
	void __iomem *addr = (void __iomem *)cbdata;
	iowrite8(reg, addr);
}

static u_int8_t k32pci2_gsm_mod_get_status(uintptr_t cbdata, size_t pos)
{
	u_int8_t reg;
	void __iomem *addr = (void __iomem *)cbdata;
	reg = ioread8(addr);
...
static void k32pci2_gsm_mod_at_write(uintptr_t cbdata, size_t pos, u_int8_t reg)
{
	void __iomem *addr = (void __iomem *)cbdata;
...
static u_int8_t k32pci2_gsm_mod_at_read(uintptr_t cbdata, size_t pos)
{
	u_int8_t reg;
	void __iomem *addr = (void __iomem *)cbdata;

	reg = ioread8(addr + 0x10);
	iowrite8(0, addr + 0x2c);
	iowrite8(1, addr + 0x2c);
	iowrite8(0, addr + 0x2c);
	return reg;
}

static u_int16_t k32pci2_gsm_mod_at_read16(uintptr_t cbdata, size_t pos)
{
	u_int16_t reg;
	void __iomem *addr = (void __iomem *)cbdata;

	reg = ioread16(addr + 0x10);
	if ((reg & 0x0200) == 0) {
		iowrite8(0, addr + 0x2c);
		iowrite8(1, addr + 0x2c);
		iowrite8(0, addr + 0x2c);
...
static void k32pci2_gsm_mod_sim_write(uintptr_t cbdata, size_t pos, u_int8_t reg)
{
	void __iomem *addr = (void __iomem *)cbdata;
...
static u_int8_t k32pci2_gsm_mod_sim_read(uintptr_t cbdata, size_t pos)
{
	u_int8_t reg;
	void __iomem *addr = (void __iomem *)cbdata;

	reg = ioread8(addr + 0x20);
...
static void k32pci2_gsm_mod_sim_do_after_reset(uintptr_t cbdata, size_t pos)
{
	void __iomem *addr = (void __iomem *)cbdata;
...
static void k32pci2_gsm_mod_imei_write(uintptr_t cbdata, size_t pos, u_int8_t reg)
{
// 	iowrite8(reg, cbdata + pos * 4 + );
}

static u_int8_t k32pci2_gsm_mod_imei_read(uintptr_t cbdata, size_t pos)
{
	return /*ioread8(cbdata + pos * 4 + )*/0;
}

static u_int8_t k32pci2_sim_read(void *data)
{
...
static void k32pci2_sim_write(void *data, u_int8_t value)
{
	struct k32_gsm_module_data *mod = (struct k32_gsm_module_data *)data;
...
static int k32pci2_sim_is_read_ready(void *data)
{
...
static int k32pci2_sim_is_write_ready(void *data)
{
	union k32_gsm_mod_status_reg status;
	struct k32_gsm_module_data *mod = (struct k32_gsm_module_data *)data;
...
static int k32pci2_sim_is_reset_request(void *data)
{
	union k32_gsm_mod_status_reg status;
	struct k32_gsm_module_data *mod = (struct k32_gsm_module_data *)data;
...
static void k32pci2_sim_set_speed(void *data, int speed)
{
	struct k32_gsm_module_data *mod = (struct k32_gsm_module_data *)data;
...
static void k32pci2_sim_do_after_reset(void *data)
{
	struct k32_gsm_module_data *mod = (struct k32_gsm_module_data *)data;
...
static int k32pci2_board_open(struct inode *inode, struct file *filp)
{
	ssize_t res;
	size_t i, j;
	size_t len;
...
static int k32pci2_board_release(struct inode *inode, struct file *filp)
{
...
static ssize_t k32pci2_board_read(struct file *filp, char __user *buff, size_t count, loff_t *offp)
{
	size_t len;
	ssize_t res;
	struct k32_board_private_data *private_data = filp->private_data;
	...
	if (res) {
		...
		if (copy_to_user(buff, private_data->buff + filp->f_pos, len)) {
			res = -EINVAL;
			goto k32pci2_board_read_end;
		}
		*offp = filp->f_pos + len;
	}

k32pci2_board_read_end:
	return res;
}

static ssize_t k32pci2_board_write(struct file *filp, const char __user *buff, size_t count, loff_t *offp)
{
	ssize_t res;
	char cmd[256];
	size_t len;
	...
	if (sscanf(cmd, "GSM%u PWR=%u", &chan, &value) == 2) {
		...
		if ((chan >= 0) && (chan <= 7)) {
			if (chan < 4) {
				iowrite8(chan % 4, private_data->board->iomem_base + (private_data->board->position * 0x400) + 0x000 + 0x1140);
			} else {
				iowrite8(chan % 4, private_data->board->iomem_base + (private_data->board->position * 0x400) + 0x200 + 0x1140);
			}
			res = len;
		} else {
			res = -ENODEV;
		...
		iowrite8(value, private_data->board->iomem_base + (private_data->board->position * 0x400) + 0x000 + 0x1190);
		iowrite8(value, private_data->board->iomem_base + (private_data->board->position * 0x400) + 0x200 + 0x1190);
		res = len;
	} else {
		res = -ENOMSG;
	}

k32pci2_board_write_end:
	return res;
}

static struct file_operations k32pci2_board_fops = {
	.owner   = THIS_MODULE,
	.open    = k32pci2_board_open,
	.release = k32pci2_board_release,
	.read    = k32pci2_board_read,
	.write   = k32pci2_board_write,
};

#if LINUX_VERSION_CODE >= KERNEL_VERSION(3,8,0)
static int k32pci2_board_probe(struct pci_dev *pdev, const struct pci_device_id *ent)
#else
static int __devinit k32pci2_board_probe(struct pci_dev *pdev, const struct pci_device_id *ent)
#endif
{
	int rc = -1;
	size_t i, j;
	...
	if (!(board = kmalloc(sizeof(struct k32_board), GFP_KERNEL))) {
		...
		goto k32pci2_board_probe_error;
	}
	...
	rc = pci_request_region(pdev, 1, "k32pci2");
	if (rc) {
		dev_err(&pdev->dev, "can't request I/O region\n");
		goto k32pci2_board_probe_error;
	}
	board->iomem_req = 1;
	if (!(board->iomem_base = pci_iomap(pdev, 1, pci_resource_end(pdev, 1) - pci_resource_start(pdev, 1) + 1))) {
		dev_err(&pdev->dev, "can't request i/o memory region\n");
		rc = -ENOMEM;
		goto k32pci2_board_probe_error;
	}
	for (i = 0; i < 4; ++i) {
		board->type = ioread16(board->iomem_base + (i * 0x400) + 0x000 + 0x11e0);
		if (board->type != 0xffff) {
			board->position = i;
			break;
		}
	}
	verbose("found PCI2 board type=%04x\n", board->type & 0x00ff);
	for (i = 1; i < 256; ++i) {
		iowrite8(i, board->iomem_base + (board->position * 0x400) + 0x000 + 0x11d0);
		board->rom[i - 1] = ioread8(board->iomem_base + (board->position * 0x400) + 0x000 + 0x11d0);
	}
 	if (rom) {
		verbose("\"%.*s\"\n", (int)255, board->rom);
 	}
	...
	if (((board->type & 0x00ff) != 0x0002) && ((board->type & 0x00ff) != 0x0004) &&
		...
		log(KERN_ERR, "PCI2 board type=%04x unsupported\n", board->type & 0x00ff);
		rc = -1;
		goto k32pci2_board_probe_error;
	}
	// reset all internal counters
	iowrite8(0, board->iomem_base + (board->position * 0x400) + 0x000 + 0x11f0);
	iowrite8(0, board->iomem_base + (board->position * 0x400) + 0x200 + 0x11f0);
	mdelay(10);
	iowrite8(1, board->iomem_base + (board->position * 0x400) + 0x000 + 0x11f0);
	iowrite8(1, board->iomem_base + (board->position * 0x400) + 0x200 + 0x11f0);
	// local oscilator
	iowrite8(0, board->iomem_base + (board->position * 0x400) + 0x000 + 0x11a0);
	iowrite8(0, board->iomem_base + (board->position * 0x400) + 0x200 + 0x11a0);
	// bank
	iowrite8(1, board->iomem_base + (board->position * 0x400) + 0x000 + 0x1190);
	iowrite8(1, board->iomem_base + (board->position * 0x400) + 0x200 + 0x1190);
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(2,6,26)
	snprintf(devname, POLYGATOR_BRDNAME_MAXLEN, "board-k32pci2-%s-%u", board->serial_number, board->position);
#else
	snprintf(devname, POLYGATOR_BRDNAME_MAXLEN, "b2%s%u", board->serial_number, board->position);
#endif
	if (!(board->pg_board = polygator_board_register(THIS_MODULE, devname, &board->cdev, &k32pci2_board_fops))) {
		rc = -1;
		goto k32pci2_board_probe_error;
	}
	...
	for (j = 0; j < 2; ++j) {
#if LINUX_VERSION_CODE >= KERNEL_VERSION(2,6,26)
		snprintf(devname, VINETIC_DEVNAME_MAXLEN, "board-k32pci2-%s-%u-vin%lu", board->serial_number, board->position, (unsigned long int)j);
#else
		snprintf(devname, VINETIC_DEVNAME_MAXLEN, "ve%s%u%lu", board->serial_number, board->position, (unsigned long int)j);
#endif
		if (!(board->vinetics[j] = vinetic_device_register(THIS_MODULE, devname, ((uintptr_t)board->iomem_base) + (board->position * 0x400),
													(j)?(k32pci2_vin_reset_1):(k32pci2_vin_reset_0),
													(j)?(k32pci2_vin_is_not_ready_1):(k32pci2_vin_is_not_ready_0),
													(j)?(k32pci2_vin_write_nwd_1):(k32pci2_vin_write_nwd_0),
													(j)?(k32pci2_vin_write_eom_1):(k32pci2_vin_write_eom_0),
													(j)?(k32pci2_vin_read_nwd_1):(k32pci2_vin_read_nwd_0),
													(j)?(k32pci2_vin_read_eom_1):(k32pci2_vin_read_eom_0),
													(j)?(k32pci2_vin_read_dia_1):(k32pci2_vin_read_dia_0)))) {
			rc = -1;
			goto k32pci2_board_probe_error;
		}
		for (i = 0; i < 4; ++i) {
#if LINUX_VERSION_CODE >= KERNEL_VERSION(2,6,26)
			snprintf(devname, VINETIC_DEVNAME_MAXLEN, "board-k32pci2-%s-%u-vin%lu-rtp%lu", board->serial_number, board->position, (unsigned long int)j, (unsigned long int)i);
#else
	...
	for (i = 0; i < 8; ++i) {
		...
		mod->pos_on_board = i;
		mod->cbdata = ((uintptr_t)board->iomem_base) + 0x1000 + board->position * 0x400 + (i / 4) * 0x200 + (i % 4) * 0x40;
		mod->set_control = k32pci2_gsm_mod_set_control;
		mod->get_status = k32pci2_gsm_mod_get_status;
		mod->at_write = k32pci2_gsm_mod_at_write;
		mod->at_read = k32pci2_gsm_mod_at_read;
		mod->at_read16 = k32pci2_gsm_mod_at_read16;
		mod->sim_write = k32pci2_gsm_mod_sim_write;
		mod->sim_read = k32pci2_gsm_mod_sim_read;
		mod->sim_do_after_reset = k32pci2_gsm_mod_sim_do_after_reset;
		...
		mod->at_port.ops = &k32pci2_tty_at_port_ops;
	...
	for (i = 0; i < 8; ++i) {
		if ((mod = board->gsm_modules[i])) {
			...
			if (!(board->tty_at_channels[i] = polygator_tty_device_register(THIS_MODULE, mod, &mod->at_port, &k32pci2_tty_at_ops))) {
#else
			if (!(board->tty_at_channels[i] = polygator_tty_device_register(THIS_MODULE, mod, &k32pci2_tty_at_ops))) {
#endif
	...
	for (i = 0; i < 8; ++i) {
		if (board->gsm_modules[i]) {
			if (!(board->simcard_channels[i] = simcard_device_register(THIS_MODULE,
																		...
																		k32pci2_sim_read,
																		k32pci2_sim_write,
																		k32pci2_sim_is_read_ready,
																		k32pci2_sim_is_write_ready,
																		k32pci2_sim_is_reset_request,
																		k32pci2_sim_set_speed,
																		k32pci2_sim_do_after_reset))) {
...
#if LINUX_VERSION_CODE >= KERNEL_VERSION(3,8,0)
static void k32pci2_board_remove(struct pci_dev *pdev)
#else
static void __devexit k32pci2_board_remove(struct pci_dev *pdev)
#endif
{
	size_t i, j;
...
static struct pci_driver k32pci2_driver = {
	.name = "k32pci2",
	.id_table = k32pci2_board_id_table,
	.probe = k32pci2_board_probe,
	.remove = k32pci2_board_remove,
};
...
#endif
static int __init k32pci2_init(void)
{
	int rc;
	...
	// Register PCI driver
	if ((rc = pci_register_driver(&k32pci2_driver)) < 0) {
		log(KERN_ERR, "can't register pci driver\n");
		goto k32pci2_init_error;
	}
...
static void __exit k32pci2_exit(void)
{
	// Unregister PCI driver
	pci_unregister_driver(&k32pci2_driver);

	verbose("stopped\n");
}

module_init(k32pci2_init);
module_exit(k32pci2_exit);
